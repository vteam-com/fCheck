...
const double _folderNestedInset = 10.0;
const double _folderNestedHeaderHeight = 24.0;
const double _folderNestedMinWidth = 1.0;
const double _folderNestedMinHeight = 1.0;
const double _folderLabelInsetX = 8.0;
const double _folderLabelInsetY = 6.0;
...
const double _classNestedInset = 8.0;
const double _classNestedHeaderHeight = 24.0;
...
const double _folderTileGap = 3.0;
const double _fileTileGap = 1.0;
